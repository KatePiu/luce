"""Esegue i 99 casi reali (situation/expected_answer/source_criterion) contro il tutor
live via /admin/test-response e salva i risultati grezzi per la revisione."""
    ...
    results.append(
        {
            ...
            "source_criterion": item["source_criterion"],
